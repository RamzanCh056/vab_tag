...
import 'package:vab_tag/Events_screen/events-screen.dart';
import 'package:vab_tag/market_screen/market_screen.dart';
import 'package:vab_tag/settings/setting_mobile.dart';
import '../blogs_one.dart';
import '../create_ad_mobile.dart';
import '../find_vibes_screen/find_vibes.dart';
import '../gift_screen/gift_screen.dart';
import '../jobs_screen/jobs_screen.dart';
import '../memories_mobile.dart';
import '../my_activity_screen/my_activity.dart';
import '../my_articles/my_articles/my_article_main_screen.dart';
import '../my_groups/my_groups_Home.dart';
             ...
             Column(
               ...
               //  contentPadding: EdgeInsets.only(left: 0.0, right: 0.0),
                 ...
                 Container(
                   ...
                   width: 30,
                   child:
                   Image.asset('assets/savepost.png',fit: BoxFit.cover,
                        color: HexColor("#FF9200")),
                 ),
                 title:
                 Text(
               ...
               ListTile(
                 ...
                 Container(
                   ...
                   width: 30,
                   child:
                   Image.asset('assets/Live broadcasting.png',fit: BoxFit.cover,
                       color: HexColor("#FF9200")),
                 ),
                 title:
                 Text(
               ...
               ListTile(
                 ...
                 Container(
                   ...
                   width: 30,
                   child:
                   Image.asset('assets/Album.png',fit: BoxFit.cover,
                    color: HexColor("#FF9200")),
                 ),
                 title:
                 Text(
               ...
               ListTile(
                 ...
                 Container(
                   ...
                   width: 30,
                   child:
                   Image.asset('images/Explore_Gold-bk.png',fit: BoxFit.cover,
                      color: HexColor("#FF9200")),
                 ),
                 title:
                 Text(
               ...
               ListTile(
                 ...
                 Container(
                   ...
                   width: 30,
                   child:
                   Image.asset('assets/Cart.png',fit: BoxFit.cover,
                    color: HexColor("#FF9200")),
                 ),
                 title:
                 Text(
               ...
               ListTile(
                 ...
                 Container(
                   ...
                   width: 30,
                   child:
                   Image.asset('assets/page.png',fit: BoxFit.cover,
                       color: HexColor("#FF9200")),
                 ),
                 title:
                 Text(
               ...
               ListTile(
                 ...
                 Container(
                   ...
                   width: 30,
                   child:
                   Image.asset('assets/team_Gold.png',fit: BoxFit.cover,
                       color: HexColor("#FF9200")),
                 ),
                 title:
                 Text(
               ...
               ListTile(
                 ...
                 Container(
                   ...
                   width: 30,
                   child:
                   Image.asset('assets/Playlists.png',fit: BoxFit.cover,
                      color: HexColor("#FF9200")),
                 ),
                 title:
                 Text(
               ...
               ListTile(
                 ...
                 Container(
                   ...
                   width: 30,
                   child:
                   Image.asset('assets/vibe.png',fit: BoxFit.cover,
                        color: HexColor("#FF9200")),
                 ),
                 title:
                 Text(
               ...
               ListTile(
                 ...
                 Container(
                   ...
                   width: 30,
                   child:
                   Image.asset('assets/Nodge.png',fit: BoxFit.cover,
                        color: HexColor("#FF9200")),
                 ),
                 title:
                 Text(
               ...
               ListTile(
                 ...
                 Container(
                   ...
                   width: 30,
                   child:
                   Image.asset('assets/popular.png',fit: BoxFit.cover,
                    color: HexColor("#FF9200")),
                 ),
                 title:
                 Text(
               ...
               ListTile(
                 ...
                 Container(
                   ...
                   width: 30,
                   child:
                   Image.asset('assets/market.png',fit: BoxFit.cover,
                       color: HexColor("#FF9200")),
                 ),
                 title:
                 Text(
               ...
               ListTile(
                 ...
                 Container(
                   ...
                   width: 30,
                   child:
                   Image.asset('assets/My_thoughts_Icon_Gold-bk.png',fit: BoxFit.cover,
                       height: 30, color: HexColor("#FF9200")),
                 ),
                 title:
                 Text(
                   'My articles',
               ...
               ListTile(
                 ...
                 Container(
                   ...
                   width: 30,
                   child:
                   Image.asset('assets/event_Gold-bk.png',fit: BoxFit.cover,
                       height: 30, color: HexColor("#FF9200")),
                 ),
                 title:
                 Text(
               ...
               ListTile(
                 ...
                 Container(
                   ...
                   width: 30,
                   child:
                   Image.asset('assets/history-icon.png',fit: BoxFit.cover,
                       height: 30, color: HexColor("#FF9200")),
                 ),
                 title:
                 Text(
               ...
               ListTile(
                 ...
                 Container(
                   ...
                   width: 30,
                   child:
                   Image.asset('assets/memory-bk.png',fit: BoxFit.cover,
                     color: HexColor("#FF9200")),
                 ),
                 title:
                 Text(
               ...
               ListTile(
                 ...
                 Container(
                   ...
                   width: 30,
                   child:
                   Image.asset('assets/jobs.png',fit: BoxFit.cover,
                      color: HexColor("#FF9200")),
                 ),
                 title:
                 Text(
               ...
               ListTile(
                 ...
                 Container(
                   height: 30,
                   width: 30,
                   child: Image.asset('assets/funding-icon.png',fit: BoxFit.cover,
                       color: HexColor("#FF9200")),
                 ),
                 title:
                 Text(
               ...
               ListTile(
                 ...
                 Container(
                   height: 30,
                   width: 30,
                   child: Image.asset('assets/offer.png',fit: BoxFit.cover,
                       color: HexColor("#FF9200")),
                 ),
                 title:
                 Text(
               ...
               ListTile(
                 ...
                 Container(
                   height: 30,
                   width: 30,
                   child: Image.asset('assets/Adverting.png',fit: BoxFit.cover,
                       color: HexColor("#FF9200")),
                 ),
                 title:
                 Text(
               ...
               ListTile(
                 ...
                 leading: Container(
                   height: 30,
                   width: 30,
                   child: Image.asset('assets/see-more-new.png',fit: BoxFit.cover,
                       color: HexColor("#FF9200")),
                 ),
                 title:Text(
                   'See more',
